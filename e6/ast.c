...
void astPrint(AST *node, int level) {
    ...
    case AST_FUNCTION_PARAMS: fprintf(stderr, "AST_FUNCTION_PARAMS");
        break;

    case AST_INT_LIST: fprintf(stderr, "AST_INT_LIST");
        break;

    case AST_CHAR_LIST: fprintf(stderr, "AST_CHAR_LIST");
        break;
